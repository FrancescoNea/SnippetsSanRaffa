...
k4me3_y_new_cpm$x <- do.call(paste, c(k4me3_y_new_cpm[cols], sep="-"))
rownames(k4me3_y_new_cpm)=make.names(k4me3_y_new_cpm$x)
k27ac_y_new_cpm$x <- do.call(paste, c(k27ac_y_new_cpm[cols], sep="-"))
rownames(k27ac_y_new_cpm)=make.names(k27ac_y_new_cpm$x)
atac_y_new_cpm$x <- do.call(paste, c(atac_y_new_cpm[cols], sep="-"))
...
MOFAobject <- createMOFAobject(ll)
